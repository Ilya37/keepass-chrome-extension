...
Когда вы заходите на сайт с сохранённым паролем (совпадающий URL):

1. Расширение автоматически находит поле пароля на странице
2. На поле пароля появляется **логотип расширения** (зелёный квадрат с замком)
3. Нажмите на иконку — имя пользователя и пароль будут заполнены автоматически
4. Popup расширения для этого открывать не нужно

Кроме того, вы можете открыть popup расширения на странице логина. Если найдётся совпадающая запись, увидите "На этой странице" с кнопкой **Заполнить**.
...
**Content Script** — обнаруживает поля пароля, запрашивает подходящие записи у background, показывает логотип KeePass на поле пароля, заполняет по клику.
